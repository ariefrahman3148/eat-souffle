...
import illustration from 'assets/images/ChocoKitkat.png';
      ...
      <Container sx={styles.container}>
        <Grid sx={styles.grid}>
          <Box sx={styles.content}>
            ...
            <Text as="p">
              Rekomendasi camilan pancake yang lembut di padukan dengan varian rasa Souffle serta topping yang cantik. Buruan cobain!
            </Text>
